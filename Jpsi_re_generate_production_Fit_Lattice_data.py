...
"""
ALL = []
sample = np.load("/home/wenbin/Downloads/Wenbin_working/Work/Berkeley_work/Yuxun_JPsi/jupyter_notebook_lattice_exp_data/samples.npy")
print(len(sample))
