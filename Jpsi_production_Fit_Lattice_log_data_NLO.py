...
for iev in range(1000):
    directory_name = "Bayesian_folder_Lattice_log_exp_data/JPsi_{}".format(int(iev))
    try:
    ...
    np.savetxt("Bayesian_folder_Lattice_log_exp_data/JPsi_{}/Bayesian_output.txt".format(int(iev)),
